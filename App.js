    ...
    <ErrorBoundary>
      <Router>
        ...
        <Routes>
          ...
          {/* Blog Pages (with ThemeProvider) */}
          <Route path="/blog" element={<ThemeProvider><BlogPage /></ThemeProvider>} />
          <Route path="/blog/:slug" element={<ThemeProvider><BlogArticle /></ThemeProvider>} />
