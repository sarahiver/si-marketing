...
export default function ModernParallaxPage() {
  ...
  return (
    <>
      ...
      {/* ── SCATTERED TITLES ── */}
      <div style={{ position: 'relative', zIndex: 2, minHeight: isMobile ? '310vh' : '310vh' }}>
        {TITLES.map((t, idx) => {
        ...
        {/* ── FOOTER ── */}
        <div style={{
          position: 'absolute', top: isMobile ? '290vh' : '290vh', left: 0, width: '100vw',
