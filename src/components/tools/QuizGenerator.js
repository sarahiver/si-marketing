...
const SheetHead = styled.div`
  ...
  p { font-family: 'Space Grotesk', monospace; font-size: 11px; letter-spacing: 0.3em; text-transform: uppercase; color: ${muted}; margin: 0 0 8px; }
...
const QCard = styled.li`
  ...
  span { font-family: 'Space Grotesk', monospace; font-size: 10px; letter-spacing: 0.14em; text-transform: uppercase; color: ${accent}; display: block; margin-bottom: 6px; }
...
const PresentKicker = styled.p`
  font-family: 'Space Grotesk', monospace; font-size: 12px; letter-spacing: 0.3em;
...
const PresentNames = styled.p`
  ...
  font-size: clamp(20px, 3vw, 30px); color: #CFC6B8; margin: 0 0 48px;
`;

const PresentNav = styled.div`
  display: flex; gap: 12px;
  button {
    font-family: 'Space Grotesk', monospace; font-size: 14px; padding: 13px 26px;
