...
const Chip = styled.button`
  ...
  span { display: block; font-size: 11px; color: ${(p) => (p.$active ? 'rgba(255,255,255,0.65)' : muted)}; margin-top: 2px; }
...
const RowAmount = styled.p`
  font-family: 'Inter', sans-serif; font-weight: 500; font-size: 15px; text-align: right; margin: 0;
`;
...
const CopyBtn = styled.button`
  font-family: 'Inter', sans-serif; font-weight: 500; font-size: 13px; padding: 12px 22px;
...
const CompactField = styled.div`
  label { display: block; font-family: 'Inter', sans-serif; font-weight: 500; font-size: 11px;
...
const BreakdownDetails = styled.details`
  margin: 0 0 8px;
  summary { cursor: pointer; font-family: 'Inter', sans-serif; font-weight: 500; font-size: 13px;
