...
const Seg = styled.div`
  ...
  button {
    font-family: 'Inter', sans-serif; font-weight: 500; font-size: 14px; padding: 10px 22px;
...
const StageKicker = styled.p`
  font-family: 'Inter', sans-serif; font-weight: 500; font-size: 11px; letter-spacing: 0.3em;
...
const Badge = styled.span`
  display: inline-block; font-family: 'Inter', sans-serif; font-weight: 500; font-size: 10px;
...
const LWDate = styled.div`
  ...
  span { display: block; font-family: 'Inter', sans-serif; font-weight: 500; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: ${accent}; margin-top: 6px; }
`;
...
const CopyBtn = styled.button`
  font-family: 'Inter', sans-serif; font-weight: 500; font-size: 13px; letter-spacing: 0.06em;
...
const CTA = styled.section`
  ...
  a {
    display: inline-block; font-family: 'Inter', sans-serif; font-weight: 500; font-size: 14px; letter-spacing: 0.06em;
